...
<Tab title="Object Params" label="Object (Structured Data Group)" default>
    ...
    - name: user_details # Our object parameter
        ...
        required: true
        properties: # Defines fields within 'user_details'
        first_name:
            type: string
...
<Tab title="Array Params" label="Array (List of Items)">
    ...
    - name: product_ids # Our array parameter
        ...
        required: true
        items: # Each item in 'product_ids' is an integer
            type: integer
    ```
</Tab>
<Tab title="Nested Objects and Arrays" label="Nested Objects and Arrays">
    ...
    - name: new_employees # An array of objects
        ...
        required: true
        items: # Each item in 'new_employees' is an object (an employee profile)
            type: object
            properties: # Fields for each employee object
            employee_id:
                type: string
            name:
                type: string
...
<Tab title="Object with Nested Object" label="Object with Nested Object">
    ...
    - name: order_request # Our main object
        ...
        order_id:
            type: string
        customer_info: # A nested object
            type: object
            description: Customer details for the order.
            properties: # Fields for 'customer_info'
            name:
                type: string
            address:
                type: string
